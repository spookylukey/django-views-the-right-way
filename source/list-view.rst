...
That's basically it! The `Paginator.get_page
<https://docs.djangoproject.com/en/stable/ref/paginator/#django.core.paginator.Paginator.get_page>`_
method returns a `Page
<https://docs.djangoproject.com/en/stable/ref/paginator/#page-class>`_ object
that has everything you need in the template — refer to the linked docs for all
the details.

Your real view might have additional needs, like filtering
